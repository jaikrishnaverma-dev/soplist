...
<div class="card-header mb-3 px-0">
    <div >
        <a href="<?php echo base_url ?>admin/?page=purchase_order/manage_po" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> New Purchase</a>
        <a href="<?php echo base_url ?>admin/?page=return/manage_return" class="btn btn-flat btn-danger"><span class="fas fa-plus"></span>  New Return</a>
        <a href="<?php echo base_url ?>admin/?page=sales/manage_sale" class="btn btn-flat btn-success"><span class="fas fa-plus"></span>  New Sale</a></div>
...
<?php require_once('stocks/index.php') ?>