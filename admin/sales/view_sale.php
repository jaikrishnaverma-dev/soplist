            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <thead>
                    <tr class="text-light bg-navy">
                        ...
                        <th class="text-center py-1 px-2">GST %</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="py-1 px-2 text-right"><?php echo $row['hsn'] ?></td>
                        <td class="py-1 px-2 text-right"><?php echo floatval($row['gst_percent']) ?></td>
                ...
                <tr>
                    ...
                    <tr>
                        <th class="text-right py-1 px-2" colspan="6">Discount <?php echo isset($discount_perc) ? $discount_perc : 0 ?>%</th>
                        <th class="text-right py-1 px-2 discount"><?php echo isset($discount) ? number_format($discount,2) : 0 ?></th>
                    </tr>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="6"><?php echo isset($is_tax_igst)&&$is_tax_igst ? "IGST" : "(SGST + CGST)" ?>
